...
ACTION_BANDS = [
    (70, "積極加碼區", "數據難得排這麼整齊，該貪的時候不要慫——但貪也要分批，不是歐印。", 2.0),
    (58, "加碼區",     "偏多。多扣一點可以，歐印不行，這兩件事很多人分不清楚。", 1.5),
    (45, "正常定額區", "不上不下，最無聊但最不會出事的位置。照表操課，把手機關掉。", 1.0),
    (35, "減碼觀望區", "數據偏弱。手癢想接刀的，先想想上次接刀的下場。少扣、留銀彈。", 0.5),
    (0,  "保守防禦區", "這位置逞英雄沒獎品。銀彈留好，活下來的人才有下一波。", 0.25),
]
