...
BAR_STYLE = (
    ...
    'border-radius:14px!important;transition:background .18s,transform .18s}'
    ...
    # 滑到反白：半透明白底圓角高亮；目前頁(.on/.hl)持續高亮；圖示變全亮+微上浮放大
    '.tabbar a.tab:hover{background:rgba(255,255,255,.22)!important}'
    '.tabbar a.tab.on,.tabbar a.tab.hl{background:rgba(255,255,255,.13)!important}'
